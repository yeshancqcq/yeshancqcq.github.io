...
var myColor = ['#a9bbd8', '#9299a3', '#b8d8db', '#badbb8', '#a1c493', '#8072a3', '#998595', '#d5dbb8', '#dbb8b8', '#d2b8db', '#a5cce5', '#bfbfbf', '#c98b48','#dbceb8']

let scaleColor = d3.scaleOrdinal(myColor);
...
let sizeScale = d3.scaleOrdinal()
    .domain(['more negative views', 'more positive views'])
    .range([5, 15] );
