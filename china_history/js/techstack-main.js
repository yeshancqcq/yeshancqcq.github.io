...
let data = [{
	...
	cat: 'library', name: 'Rapha毛l', value: 10,
	icon: 'img/raphael.svg',
	desc: `
		Rapha毛l is a cross-browser JavaScript library that draws Vector graphics for web sites.
	...
	desc: `
		...
		Redux is inspired by Facebook鈥檚 Flux and influenced by functional programming language Elm.
	`
}, {
...
},*/
{
	...
	`
		...
		icon: 'img/ember.png',
		desc: `
		Ember.js is an open-source JavaScript web framework, based on the Model鈥搗iew鈥搗iewmodel
	...
	desc: `
		...
		It integrates with MongoDB and uses the Distributed Data Protocol and a publish鈥搒ubscribe
